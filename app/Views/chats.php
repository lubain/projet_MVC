...
<body>
    ...
    <div class="wrapper">
        <div class="conversation-area">
            ...
            <a href="chats/<?= esc($conversation->id) ?>" class="msg online" style="text-decoration: none;">
                ...
                <div class="msg-detail">
                    ...
                    <div class="msg-content">
                        <span class="msg-message"><?php if (esc($conversation->sender_id)==session()->get('id')){echo "vous: ";} ?><?= esc($conversation->content) ?></span>
        ...
        <div class="chat-area chatArea">
            ...
            <form method="post" class="chat-area-footer">
                ...
                <div style="background: none;border:none;margin: 5px 0 0 5px">
