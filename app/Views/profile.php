  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?= base_url("public/")?>" class="nav-link"><i class="fas fa-home"></i></a>
      </li>
    </ul>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= base_url("public/chats/" . $user["id"])?>" class="nav-link">
                  ...
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="post clearfix">
                      <div class="user-block">
                        ...
                        <span class="username">
                          <a href="<?= esc($publication->sender_id) ?>"><?= esc($publication->nom) ?> <?= esc($publication->prenom) ?></a>
                        </span>
                  ...
                  <div class="active tab-pane" id="resultat">
                      ...
                      <div class="post clearfix">
                          <div class="user-block">
                            ...
                            <span class="username">
                                <a href="#profil<?= $row["id"]?>"><?= $row["nom"]?> <?= $row["prenom"]?></a>
